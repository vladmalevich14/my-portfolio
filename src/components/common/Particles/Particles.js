...
const ParticlesComponent = (props) => {
    ...
    const options = useMemo(() => {
        ...
        return {
            ...
            interactivity: {
                ...
                modes: {
                    push: {
                        quantity: 14, // number of particles to add on click
                    },
                    repulse: {
    ...
    return <Particles className={styles.tsParticles} id={props.id} init={particlesInit} options={options} loaded={particlesLoaded}/>;
};
